...
となります。Scalaでは標準で[`Predef`という`object`](https://github.com/scala/scala3/blob/3.9.0/library/src/scala/Predef.scala)が定義・インポートされており、これは最初の使い方に当てはまります。 `println("Hello")` となにげなく
