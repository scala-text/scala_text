...
[info] downloading https://repo1.maven.org/maven2/org/scalatest/scalatest_2.13/3.2.3/scalatest_2.13-3.2.3.jar ...
[info] 	[SUCCESSFUL ] org.scalatest#scalatest_2.13;3.2.3!scalatest_2.13.jar(bundle) (10199ms)
[info] Done updating.
...
```scala
libraryDependencies += "org.mockito" % "mockito-core" % "3.6.28" % "test"
```
