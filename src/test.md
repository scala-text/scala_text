...
[info] Compiling 1 Scala source to /Users/dwango/workspace/scalatest_study/target/scala-3.7.3/classes...
[info] Compiling 1 Scala source to /Users/dwango/workspace/scalatest_study/target/scala-3.7.3/test-classes...
[info] CalcSpec:
[info] sum関数
...
その後、`sbt clean coverage test coverageReport`を実行することで、`target/scala-3.7.3/scoverage-report/index.html`にレポートが出力されます。
