...
### [Option](https://github.com/scala/scala/blob/v2.11.7/src/library/scala/Option.scala)
...
例えば、1つ目と2つ目の整数の値がOptionで帰ってきてそれをかけた値をもとめるような場合です。
...
### [Either](https://github.com/scala/scala/blob/v2.11.7/src/library/scala/util/Either.scala)
...
### [Try](https://github.com/scala/scala/blob/v2.11.7/src/library/scala/util/Try.scala)
...
#### [`NonFatal`](https://github.com/scala/scala/blob/v2.11.7/src/library/scala/util/control/NonFatal.scala)の例外
