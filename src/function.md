...
[`Function0`](https://github.com/scala/scala3/blob/3.9.0/library/src/scala/Function0.scala) 〜 [`Function22`](https://github.com/scala/scala3/blob/3.8.4/library/src/scala/Function22.scala) までのトレイトの無名サブクラスのインスタンスなのです。
