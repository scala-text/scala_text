...
[`Function0`](https://github.com/scala/scala/blob/v2.13.2/src/library/scala/Function0.scala) 〜 [`Function22`](https://github.com/scala/scala/blob/v2.13.2/src/library/scala/Function22.scala) までのトレイトの無名サブクラスのインスタンスなのです。
